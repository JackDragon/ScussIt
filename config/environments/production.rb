Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {:host => 'http://warm-mountain-1838.herokuapp.com/', :protocol => 'http'}
  ...
  config.action_mailer.smtp_settings = {
   ...
   #   :user_name => ENV['jon.lo.hs@gmail.com'],
   #   :password => ENV['n1blheim']
